...
define(['./colorscheme', '../h'], function(colorscheme_repo, h) {
    ...
    let exports = function render(spec, colorscheme) {
        ...
        spec.pages.forEach(function(pspec) {
            ...
            let pel = renderPage(pspec, spec.pagewidth, spec.pageheight, colorscheme);
            pel.style.height =  toCssUnits(spec.pageheight);
            pel.style.width  =  toCssUnits(spec.pagewidth),
            pel.style.position = 'relative';
            pel.style.margin = '1em';
    ...
    function renderPage(pspec, pagewidth, pageheight, colorscheme) {
        let pel = h('svg', {
            'class': 'page',
            'width': pagewidth,
            'height': pageheight,
